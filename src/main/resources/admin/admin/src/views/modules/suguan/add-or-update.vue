	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="宿管员姓名" prop="suguanxingming">
					<el-input v-model="ruleForm.suguanxingming" placeholder="宿管员姓名" clearable  :readonly="ro.suguanxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="宿管员姓名" prop="suguanxingming">
					<el-input v-model="ruleForm.suguanxingming" placeholder="宿管员姓名" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="宿管员电话" prop="dianhua">
					<el-input v-model="ruleForm.dianhua" placeholder="宿管员电话" clearable  :readonly="ro.dianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="宿管员电话" prop="dianhua">
					<el-input v-model="ruleForm.dianhua" placeholder="宿管员电话" readonly></el-input>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				suguanxingming: [
					{ required: true, message: '宿管员姓名不能为空', trigger: 'blur' },
				],
				xingbie: [
				],
				touxiang: [
