...
public class FaceUtil {
    ...
    public static JSONObject searchFace(String base64Image) throws IOException {
        ...
        return result.getJSONArray("user_list").getJSONObject(0);
    }

    public static String findFace(String base64Image) throws IOException {
        JSONObject userInfo = searchFace(base64Image);
        if (userInfo != null && userInfo.has("user_id")) {
