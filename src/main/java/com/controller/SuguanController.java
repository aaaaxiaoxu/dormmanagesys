...
public class SuguanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		SuguanEntity u = suguanService.selectOne(new EntityWrapper<SuguanEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody SuguanEntity suguan){
    	...
    	SuguanEntity u = suguanService.selectOne(new EntityWrapper<SuguanEntity>().eq("zhanghao", suguan.getZhanghao()));
		if(u!=null) {
